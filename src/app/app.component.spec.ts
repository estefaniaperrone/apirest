...
describe('AppComponent', () => {
  ...
  // it(`should have as title 'perrone-final'`, () => {
  //   const fixture = TestBed.createComponent(AppComponent);
  //   const app = fixture.componentInstance;
  //   expect(app.title).toEqual('perrone-final');
  // });
  ...
  //   expect(compiled.querySelector('.content span')?.textContent).toContain('perrone-final app is running!');
  // });
});
